...
print("===========================================")
print("check tensorflow devices")
...
if cap.cap.isOpened():
    ...
    while cv2.getWindowProperty("Object detector", 0) >= 0:
        ...
        frame_rgb = cv2.cvtColor(cap.frame, cv2.COLOR_BGR2RGB)
        ...
        for i in range(len(scores)):
            if ((scores[i] > min_conf_threshold) and (scores[i] <= 1.0)):
                ...
                cv2.rectangle(cap.frame, (xmin,ymin), (xmax,ymax), (10, 255, 0), 2)
                ...
                cv2.rectangle(cap.frame, (xmin, label_ymin-labelSize[1]-10), (xmin+labelSize[0], label_ymin+baseLine-10), (255, 255, 255), cv2.FILLED) # Draw white box to put label text in
