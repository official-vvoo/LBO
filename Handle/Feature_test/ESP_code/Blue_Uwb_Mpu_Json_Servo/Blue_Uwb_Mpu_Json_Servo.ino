...
// --------   UWB value (start)    --------    
volatile int is_receivedAck_entry = 0;
...
void TaskUWB(void *param) {
  for(;;) {
    // if(xSemaphoreTake(uwb_semaphore_b, portMAX_DELAY) == pdTRUE) {
...
void TaskUwbDebug(void *param) {
  for(;;){
    ...
    Serial.print("is_debug3: ");
    Serial.println(is_debug3);
    Serial.print("is_debug4: ");
    Serial.println(is_debug4);
    
    Serial.print("is_debug5[0]: ");
    Serial.println(is_debug5[0]);
    Serial.print("is_debug5[1]: ");
    Serial.println(is_debug5[1]);
    Serial.print("is_debug5[2]: ");
    Serial.println(is_debug5[2]);
    Serial.print("is_debug5[3]: ");
    Serial.println(is_debug5[3]);
...
void setup() {
  ...
  // imu_semaphore_b = xSemaphoreCreateBinary();
  // uwb_semaphore_b = xSemaphoreCreateBinary();
  ...
  // ServoMotor.write(angle);
  // xTaskCreate(TaskServo, "TaskServo", 2048, NULL, 12, NULL);
